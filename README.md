...
**A gamified campus study app that turns extra study time, peer help, and group sessions into an engaging, rewarding experience.**

CampusBoost encourages university students to spend more time learning on campus outside of class hours. By applying game mechanics — points, badges, streaks, leaderboards, quests, and a virtual shop — the system makes self‑directed study consistent, social, and fun.
...
Set a daily goal — hit it to unlock the “Goal Crusher” badge and bonus XP.

Build a daily streak; 7 days unlocks “Campus Scholar”.
...
The asker can mark a reply as “Helpful” → the helper gets a +20 CP bonus and a “Verified Helper” tag.

Upvote answers; every 5 upvotes awards “Community Approved”.

Track subject mastery: Novice → Apprentice → Expert → Guru.
...
After the session, check in to earn Social Learning Points (SLP).

Organizer gets an extra “Initiator” bonus.
